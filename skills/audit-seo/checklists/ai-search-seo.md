...
> **Note de scope :** ces concerns sont génériques web (projet sous ton contrôle, audité depuis son code source). Les pages de marketplace / store listing à rendu automatique par une plateforme tierce sortent du périmètre de ce skill.
